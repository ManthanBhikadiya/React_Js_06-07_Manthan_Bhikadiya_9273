...
const Header = () => {
  return (
    <header className="relative overflow-hidden bg-blue-500 text-white shadow-lg">
      <div className="absolute -left-16 -top-16 h-48 w-48 rounded-full bg-white/10 blur-2xl" />
      <div className="absolute -right-16 bottom-0 h-48 w-48 rounded-full bg-fuchsia-200/20 blur-2xl" />
